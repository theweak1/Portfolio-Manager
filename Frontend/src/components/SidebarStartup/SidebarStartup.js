	...
	return (
		<>
			...
			<nav
				className={
					sidebar
						? 'fixed flex justify-center w-44 sm:w-52 md:w-60 h-full z-10 top-0 left-0 transition-all duration-[250ms] ease-out  bg-white shadow-sm mt-20'
						: 'fixed flex justify-center w-44 sm:w-52 md:w-60 h-full z-10 top-0 -left-full transition-all duration-[250ms] ease-in bg-white shadow-sm mt-20'
				}
			>
