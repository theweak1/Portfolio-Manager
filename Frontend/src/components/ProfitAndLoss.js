...
const ProfitAndLoss = ({statementData}) => {
  ...
  return (
    <div className="p-6 max-w-lg max-h-lg mx-auto bg-white rounded-xl shadow-md space-y-6 ">
      <div className="ml-2 ">
        <h2 className="text-2xl font-bold mb-5 text-black text-center">Profit & Loss</h2>
        <table className="table-auto border-collapse border border-gray-800 w-full">
          <tbody>
            {statementData.map((item, index) => (
              <tr key={index} className="text-black text-xl">
